...
wget --user xxx --ask-password https://repoee.postgrespro.ru/ent-15/keys/pgpro-repo-add.sh
...
systemctl stop postgrespro-ent-15
systemctl disable postgrespro-ent-15

rm /lib/systemd/system/postgrespro-ent-15.service

rm -r /var/lib/pgpro/ent-15/data/*
...
#  proxy_address: 127.0.0.1:5433  # The address of connection pool (e.g., pgbouncer) running next to Patroni/Postgres. Only for service discovery.
  data_dir: /var/lib/pgpro/ent-15/data
  bin_dir: /opt/pgpro/ent-15/bin
#  config_dir:
  pgpass: /tmp/pgpass0
  authentication:
    replication:
